...
if __name__ == '__main__':
    ...
    fig = get_figure_registered_vehicles()
    fig.show()
    # get_figure_waiting_hours_by_load(queues_names=[ct.CAR_LIVE_QUEUE_KEY, ct.BUS_LIVE_QUEUE_KEY])
    # get_figure_vehicle_count_per_regions(get_figure_type='line')
    # get_figure_frequent_vehicles_registrations_count(has_been_called=True)
